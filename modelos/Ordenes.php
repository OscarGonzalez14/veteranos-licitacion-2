...
require_once("../config/conexion.php");  
  ...
  /////////////   REGISTRAR ORDEN ///////////////////////////////
  public function registrar_orden($correlativo_op,$paciente,$od_pupilar,$oipupilar,$odlente,$oilente,$marca_aro_orden,$modelo_aro_orden,$horizontal_aro_orden,$vertical_aro_orden,$puente_aro_orden,$id_usuario,$observaciones_orden,$dui,$od_esferas,$od_cilindros,$od_eje,$od_adicion,$oi_esferas,$oi_cilindros,$oi_eje,$oi_adicion,$tipo_lente,$color_varilla,$color_frente,$imagen,$edad,$usuario,$ocupacion,$avsc,$avfinal,$avsc_oi,$avfinal_oi,$telefono,$genero,$user,$depto,$municipio,$instit){
   ...
   ////////////////////LISTAR ORDENES///////////////
public function editar_orden($correlativo_op,$paciente,$fecha_creacion,$od_pupilar,$oipupilar,$odlente,$oilente,$marca_aro_orden,$modelo_aro_orden,$horizontal_aro_orden,$vertical_aro_orden,$puente_aro_orden,$id_usuario,$observaciones_orden,$dui,$od_esferas,$od_cilindros,$od_eje,$od_adicion,$oi_esferas,$oi_cilindros,$oi_eje,$oi_adicion,$tipo_lente,$color_varilla,$color_frente,$categoria_lente,$imagen,$edad,$usuario,$ocupacion,$avsc,$avfinal,$avsc_oi,$avfinal_oi,$telefono,$genero,$depto,$municipio,$instit){
  $conectar = parent::conexion();
...
public function get_ordenes_enviar_general($instit){
      ...
      from
      orden_lab as o inner join rx_orden_lab as rx on o.codigo=rx.codigo where o.estado='0' and (o.institucion='INABVE' OR o.institucion='') order by o.fecha ASC;";
      $sql=$conectar->prepare($sql);
      $sql->execute();
      return $resulta = $sql->fetchAll(PDO::FETCH_ASSOC);
    }else{
      $sql = "select o.institucion,o.id_orden,o.codigo,o.paciente,o.fecha,o.pupilar_od,o.pupilar_oi,o.lente_od,o.lente_oi,o.marca_aro,o.modelo_aro,o.horizontal_aro,o.vertical_aro,o.puente_aro,o.id_usuario,o.observaciones,o.dui,o.estado,o.tipo_lente,rx.od_esferas,rx.od_cilindros,rx.od_eje,rx.od_adicion,rx.oi_esferas,rx.oi_cilindros,rx.oi_eje,rx.oi_adicion
      from
      orden_lab as o inner join rx_orden_lab as rx on o.codigo=rx.codigo where o.estado='0' and o.institucion='FOPROLYD' order by o.fecha ASC;";
      $sql=$conectar->prepare($sql);
      $sql->execute();
      return $resulta = $sql->fetchAll(PDO::FETCH_ASSOC);
    }
